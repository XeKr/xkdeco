...
public class HollowSteelObliqueBeamBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hollow_steel_oblique_beam")
	public static final Block block = null;
	public HollowSteelObliqueBeamBlock(XkdecoModElements instance) {
		super(instance, 738);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("hollow_steel_oblique_beam");
		}
