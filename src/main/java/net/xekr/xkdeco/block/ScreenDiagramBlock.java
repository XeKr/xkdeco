...
public class ScreenDiagramBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:screen_diagram")
	public static final Block block = null;
	public ScreenDiagramBlock(XkdecoModElements instance) {
		super(instance, 809);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("screen_diagram");
		}
