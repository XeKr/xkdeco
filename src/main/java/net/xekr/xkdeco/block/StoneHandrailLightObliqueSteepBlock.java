...
public class StoneHandrailLightObliqueSteepBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:stone_handrail_light_oblique_steep")
	public static final Block block = null;
	public StoneHandrailLightObliqueSteepBlock(XkdecoModElements instance) {
		super(instance, 721);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_handrail_light_oblique_steep");
		}
