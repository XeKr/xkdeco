...
public class SmallBlackRoofSteepSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_black_roof_steep_side")
	public static final Block block = null;
	public SmallBlackRoofSteepSideBlock(XkdecoModElements instance) {
		super(instance, 679);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_black_roof_steep_side");
		}
