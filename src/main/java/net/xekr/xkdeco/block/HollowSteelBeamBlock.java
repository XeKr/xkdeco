...
public class HollowSteelBeamBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hollow_steel_beam")
	public static final Block block = null;
	public HollowSteelBeamBlock(XkdecoModElements instance) {
		super(instance, 735);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("hollow_steel_beam");
		}
