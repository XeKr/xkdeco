...
public class CyanRoofFlatBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cyan_roof_flat")
	public static final Block block = null;
	public CyanRoofFlatBlock(XkdecoModElements instance) {
		super(instance, 680);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("cyan_roof_flat");
		}
