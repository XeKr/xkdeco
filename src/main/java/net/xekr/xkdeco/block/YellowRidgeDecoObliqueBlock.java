...
public class YellowRidgeDecoObliqueBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:yellow_ridge_deco_oblique")
	public static final Block block = null;
	public YellowRidgeDecoObliqueBlock(XkdecoModElements instance) {
		super(instance, 691);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_ridge_deco_oblique");
		}
