...
public class SmallCyanRoofSteepSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_cyan_roof_steep_side")
	public static final Block block = null;
	public SmallCyanRoofSteepSideBlock(XkdecoModElements instance) {
		super(instance, 688);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_cyan_roof_steep_side");
		}
