...
public class MayaPolishedStonebrickSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_polished_stonebrick_slab")
	public static final Block block = null;
	public MayaPolishedStonebrickSlabBlock(XkdecoModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_polished_stonebrick_slab");
		}
