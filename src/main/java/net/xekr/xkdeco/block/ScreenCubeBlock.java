...
public class ScreenCubeBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:screen_cube")
	public static final Block block = null;
	public ScreenCubeBlock(XkdecoModElements instance) {
		super(instance, 808);
	}
