...
public class NetherrackSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:netherrack_slab")
	public static final Block block = null;
	public NetherrackSlabBlock(XkdecoModElements instance) {
		super(instance, 576);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.NETHERRACK).hardnessAndResistance(0.5f, 0.5f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("netherrack_slab");
		}
