...
public class MahoganyBracketInterpolationBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mahogany_bracket_interpolation")
	public static final Block block = null;
	public MahoganyBracketInterpolationBlock(XkdecoModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mahogany_bracket_interpolation");
		}
