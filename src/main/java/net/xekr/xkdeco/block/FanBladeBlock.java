...
public class FanBladeBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:fan_blade")
	public static final Block block = null;
	public FanBladeBlock(XkdecoModElements instance) {
		super(instance, 775);
	}
