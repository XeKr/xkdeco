...
public class SandstoneSmallBrickStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:sandstone_small_brick_stair")
	public static final Block block = null;
	public SandstoneSmallBrickStairBlock(XkdecoModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sandstone_small_brick_stair");
		}
