...
public class RedRoofSteepSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof_steep_side")
	public static final Block block = null;
	public RedRoofSteepSideBlock(XkdecoModElements instance) {
		super(instance, 255);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_roof_steep_side");
		}
