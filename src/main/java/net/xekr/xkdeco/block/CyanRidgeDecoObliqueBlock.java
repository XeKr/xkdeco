...
public class CyanRidgeDecoObliqueBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cyan_ridge_deco_oblique")
	public static final Block block = null;
	public CyanRidgeDecoObliqueBlock(XkdecoModElements instance) {
		super(instance, 682);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_ridge_deco_oblique");
		}
