...
public class SandyCobblestoneBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:sandy_cobblestone")
	public static final Block block = null;
	public SandyCobblestoneBlock(XkdecoModElements instance) {
		super(instance, 582);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandy_cobblestone");
		}
