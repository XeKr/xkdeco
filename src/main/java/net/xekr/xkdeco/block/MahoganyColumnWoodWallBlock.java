...
public class MahoganyColumnWoodWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mahogany_column_wood_wall")
	public static final Block block = null;
	public MahoganyColumnWoodWallBlock(XkdecoModElements instance) {
		super(instance, 149);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mahogany_column_wood_wall");
		}
