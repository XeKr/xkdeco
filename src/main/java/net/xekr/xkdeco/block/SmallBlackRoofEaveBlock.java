...
public class SmallBlackRoofEaveBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_black_roof_eave")
	public static final Block block = null;
	public SmallBlackRoofEaveBlock(XkdecoModElements instance) {
		super(instance, 675);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_black_roof_eave");
		}
