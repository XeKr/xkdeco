...
public class GreenTileStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_tile_stair")
	public static final Block block = null;
	public GreenTileStairBlock(XkdecoModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_tile_stair");
		}
