...
public class RedTilesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_tiles")
	public static final Block block = null;
	public RedTilesBlock(XkdecoModElements instance) {
		super(instance, 229);
	}
