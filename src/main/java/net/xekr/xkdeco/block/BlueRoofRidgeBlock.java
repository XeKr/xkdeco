...
public class BlueRoofRidgeBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_roof_ridge")
	public static final Block block = null;
	public BlueRoofRidgeBlock(XkdecoModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_roof_ridge");
		}
