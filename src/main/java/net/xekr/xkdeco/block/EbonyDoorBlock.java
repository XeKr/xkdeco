...
public class EbonyDoorBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ebony_door")
	public static final Block block = null;
	public EbonyDoorBlock(XkdecoModElements instance) {
		super(instance, 68);
	}
