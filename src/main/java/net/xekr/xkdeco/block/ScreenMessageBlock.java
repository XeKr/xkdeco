...
public class ScreenMessageBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:screen_message")
	public static final Block block = null;
	public ScreenMessageBlock(XkdecoModElements instance) {
		super(instance, 812);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("screen_message");
		}
