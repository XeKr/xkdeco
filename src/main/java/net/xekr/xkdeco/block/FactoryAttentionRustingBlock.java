...
public class FactoryAttentionRustingBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_attention_rusting")
	public static final Block block = null;
	public FactoryAttentionRustingBlock(XkdecoModElements instance) {
		super(instance, 482);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_attention_rusting");
		}
