...
public class BlackRoofSteepSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:black_roof_steep_side")
	public static final Block block = null;
	public BlackRoofSteepSideBlock(XkdecoModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_roof_steep_side");
		}
