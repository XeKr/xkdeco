...
public class RedRoofSlowBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof_slow")
	public static final Block block = null;
	public RedRoofSlowBlock(XkdecoModElements instance) {
		super(instance, 252);
	}
