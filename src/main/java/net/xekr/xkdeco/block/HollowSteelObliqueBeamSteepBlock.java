...
public class HollowSteelObliqueBeamSteepBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hollow_steel_oblique_beam_steep")
	public static final Block block = null;
	public HollowSteelObliqueBeamSteepBlock(XkdecoModElements instance) {
		super(instance, 740);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("hollow_steel_oblique_beam_steep");
		}
