...
public class FactoryElectricityBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_electricity")
	public static final Block block = null;
	public FactoryElectricityBlock(XkdecoModElements instance) {
		super(instance, 484);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_electricity");
		}
