...
public class WhitePorcelainTallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:white_porcelain_tall")
	public static final Block block = null;
	public WhitePorcelainTallBlock(XkdecoModElements instance) {
		super(instance, 152);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("white_porcelain_tall");
		}
