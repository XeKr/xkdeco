...
public class FactoryElectricityRustingBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_electricity_rusting")
	public static final Block block = null;
	public FactoryElectricityRustingBlock(XkdecoModElements instance) {
		super(instance, 485);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_electricity_rusting");
		}
