...
public class FactoryTrapdoorBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_trapdoor")
	public static final Block block = null;
	public FactoryTrapdoorBlock(XkdecoModElements instance) {
		super(instance, 772);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("factory_trapdoor");
		}
