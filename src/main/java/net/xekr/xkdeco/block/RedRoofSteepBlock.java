...
public class RedRoofSteepBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof_steep")
	public static final Block block = null;
	public RedRoofSteepBlock(XkdecoModElements instance) {
		super(instance, 254);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_roof_steep");
		}
