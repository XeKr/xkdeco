...
public class SteelTilesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:steel_tiles")
	public static final Block block = null;
	public SteelTilesBlock(XkdecoModElements instance) {
		super(instance, 9);
	}
