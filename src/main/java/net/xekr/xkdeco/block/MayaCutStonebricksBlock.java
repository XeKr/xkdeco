...
public class MayaCutStonebricksBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_cut_stonebricks")
	public static final Block block = null;
	public MayaCutStonebricksBlock(XkdecoModElements instance) {
		super(instance, 271);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("maya_cut_stonebricks");
		}
