...
public class HologramMessageItem extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hologram_message")
	public static final Item block = null;
	public HologramMessageItem(XkdecoModElements instance) {
		super(instance, 827);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hologram_message");
		}
