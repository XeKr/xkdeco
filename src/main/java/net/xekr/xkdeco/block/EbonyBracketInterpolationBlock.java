...
public class EbonyBracketInterpolationBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ebony_bracket_interpolation")
	public static final Block block = null;
	public EbonyBracketInterpolationBlock(XkdecoModElements instance) {
		super(instance, 188);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ebony_bracket_interpolation");
		}
