...
public class RomanDoricColumnBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:roman_doric_column_base")
	public static final Block block = null;
	public RomanDoricColumnBaseBlock(XkdecoModElements instance) {
		super(instance, 328);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("roman_doric_column_base");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 5, 16), makeCuboidShape(2, 5, 2, 14, 16, 14)).withOffset(offset.x, offset.y, offset.z);
		}
