...
public class RedMapleLeavesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_maple_leaves")
	public static final Block block = null;
	public RedMapleLeavesBlock(XkdecoModElements instance) {
		super(instance, 609);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("red_maple_leaves");
		}
