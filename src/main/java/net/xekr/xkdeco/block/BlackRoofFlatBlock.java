...
public class BlackRoofFlatBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:black_roof_flat")
	public static final Block block = null;
	public BlackRoofFlatBlock(XkdecoModElements instance) {
		super(instance, 667);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("black_roof_flat");
		}
