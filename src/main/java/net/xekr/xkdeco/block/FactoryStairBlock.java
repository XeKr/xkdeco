...
public class FactoryStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_stair")
	public static final Block block = null;
	public FactoryStairBlock(XkdecoModElements instance) {
		super(instance, 471);
	}
