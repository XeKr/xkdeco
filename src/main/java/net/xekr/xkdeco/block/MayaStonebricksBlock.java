...
public class MayaStonebricksBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_stonebricks")
	public static final Block block = null;
	public MayaStonebricksBlock(XkdecoModElements instance) {
		super(instance, 262);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("maya_stonebricks");
		}
