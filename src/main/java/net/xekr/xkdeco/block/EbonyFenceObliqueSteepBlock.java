...
public class EbonyFenceObliqueSteepBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ebony_fence_oblique_steep")
	public static final Block block = null;
	public EbonyFenceObliqueSteepBlock(XkdecoModElements instance) {
		super(instance, 714);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("ebony_fence_oblique_steep");
		}
