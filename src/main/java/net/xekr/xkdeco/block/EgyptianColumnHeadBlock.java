...
public class EgyptianColumnHeadBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_column_head")
	public static final Block block = null;
	public EgyptianColumnHeadBlock(XkdecoModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_column_head");
		}
