...
public class HollowSteelTrapdoorBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hollow_steel_trapdoor")
	public static final Block block = null;
	public HollowSteelTrapdoorBlock(XkdecoModElements instance) {
		super(instance, 736);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("hollow_steel_trapdoor");
		}
