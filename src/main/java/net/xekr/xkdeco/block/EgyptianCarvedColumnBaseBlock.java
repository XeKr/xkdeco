...
public class EgyptianCarvedColumnBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_carved_column_base")
	public static final Block block = null;
	public EgyptianCarvedColumnBaseBlock(XkdecoModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_carved_column_base");
		}
