...
public class MayaStonebrickStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_stonebrick_stair")
	public static final Block block = null;
	public MayaStonebrickStairBlock(XkdecoModElements instance) {
		super(instance, 264);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_stonebrick_stair");
		}
