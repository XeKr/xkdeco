...
public class WoodColumnWoodWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:wood_column_wood_wall")
	public static final Block block = null;
	public WoodColumnWoodWallBlock(XkdecoModElements instance) {
		super(instance, 152);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wood_column_wood_wall");
		}
