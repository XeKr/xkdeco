...
public class SmallYellowRoofEaveSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_yellow_roof_eave_side")
	public static final Block block = null;
	public SmallYellowRoofEaveSideBlock(XkdecoModElements instance) {
		super(instance, 694);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_yellow_roof_eave_side");
		}
