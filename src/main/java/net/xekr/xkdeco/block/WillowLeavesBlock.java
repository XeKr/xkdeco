...
public class WillowLeavesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:willow_leaves")
	public static final Block block = null;
	public WillowLeavesBlock(XkdecoModElements instance) {
		super(instance, 617);
