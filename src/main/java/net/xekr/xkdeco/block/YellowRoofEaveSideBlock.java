...
public class YellowRoofEaveSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:yellow_roof_eave_side")
	public static final Block block = null;
	public YellowRoofEaveSideBlock(XkdecoModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_roof_eave_side");
		}
