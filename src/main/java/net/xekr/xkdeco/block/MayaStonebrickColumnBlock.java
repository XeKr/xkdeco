...
public class MayaStonebrickColumnBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_stonebrick_column")
	public static final Block block = null;
	public MayaStonebrickColumnBlock(XkdecoModElements instance) {
		super(instance, 273);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("maya_stonebrick_column");
		}
