...
public class BlueRoofBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_roof")
	public static final Block block = null;
	public BlueRoofBlock(XkdecoModElements instance) {
		super(instance, 232);
	}
