...
public class RomanCorinthianColumnHeadBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:roman_corinthian_column_head")
	public static final Block block = null;
	public RomanCorinthianColumnHeadBlock(XkdecoModElements instance) {
		super(instance, 336);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("roman_corinthian_column_head");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(1, 0, 1, 15, 11, 15), makeCuboidShape(0, 11, 0, 16, 16, 16)).withOffset(offset.x, offset.y,
					offset.z);
		}
