...
public class EbonyColumnMudWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ebony_column_mud_wall")
	public static final Block block = null;
	public EbonyColumnMudWallBlock(XkdecoModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("ebony_column_mud_wall");
		}
