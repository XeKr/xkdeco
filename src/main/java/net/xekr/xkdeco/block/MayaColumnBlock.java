...
public class MayaColumnBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_column")
	public static final Block block = null;
	public MayaColumnBlock(XkdecoModElements instance) {
		super(instance, 274);
	}
