...
public class DirtCobblestonePathStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:dirt_cobblestone_path_stair")
	public static final Block block = null;
	public DirtCobblestonePathStairBlock(XkdecoModElements instance) {
		super(instance, 603);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dirt_cobblestone_path_stair");
		}
