...
public class MahoganyColumnMudWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mahogany_column_mud_wall")
	public static final Block block = null;
	public MahoganyColumnMudWallBlock(XkdecoModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mahogany_column_mud_wall");
		}
