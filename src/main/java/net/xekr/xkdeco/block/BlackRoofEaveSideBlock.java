...
public class BlackRoofEaveSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:black_roof_eave_side")
	public static final Block block = null;
	public BlackRoofEaveSideBlock(XkdecoModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_roof_eave_side");
		}
