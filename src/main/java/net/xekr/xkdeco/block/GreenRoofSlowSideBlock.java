...
public class GreenRoofSlowSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof_slow_side")
	public static final Block block = null;
	public GreenRoofSlowSideBlock(XkdecoModElements instance) {
		super(instance, 244);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_roof_slow_side");
		}
