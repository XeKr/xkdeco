...
public class GrassCobblestoneStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:grass_cobblestone_stair")
	public static final Block block = null;
	public GrassCobblestoneStairBlock(XkdecoModElements instance) {
		super(instance, 599);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("grass_cobblestone_stair");
		}
