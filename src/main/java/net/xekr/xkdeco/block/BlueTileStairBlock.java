...
public class BlueTileStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_tile_stair")
	public static final Block block = null;
	public BlueTileStairBlock(XkdecoModElements instance) {
		super(instance, 225);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_tile_stair");
		}
