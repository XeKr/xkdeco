...
public class VentiductCoverBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ventiduct_cover")
	public static final Block block = null;
	public VentiductCoverBlock(XkdecoModElements instance) {
		super(instance, 749);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("ventiduct_cover");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case UP :
					return VoxelShapes.or(makeCuboidShape(0, 1, 0, 16, 0, 16)).withOffset(offset.x, offset.y, offset.z);
				case DOWN :
					return VoxelShapes.or(makeCuboidShape(0, 15, 16, 16, 16, 0)).withOffset(offset.x, offset.y, offset.z);
			}
		}
