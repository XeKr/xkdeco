...
public class FactoryToxicRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_toxic_rusted")
	public static final Block block = null;
	public FactoryToxicRustedBlock(XkdecoModElements instance) {
		super(instance, 489);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_toxic_rusted");
		}
