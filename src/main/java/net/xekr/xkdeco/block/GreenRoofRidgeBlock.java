...
public class GreenRoofRidgeBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof_ridge")
	public static final Block block = null;
	public GreenRoofRidgeBlock(XkdecoModElements instance) {
		super(instance, 249);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("green_roof_ridge");
		}
