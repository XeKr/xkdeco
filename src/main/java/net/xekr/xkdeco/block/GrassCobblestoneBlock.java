...
public class GrassCobblestoneBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:grass_cobblestone")
	public static final Block block = null;
	public GrassCobblestoneBlock(XkdecoModElements instance) {
		super(instance, 581);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("grass_cobblestone");
		}
