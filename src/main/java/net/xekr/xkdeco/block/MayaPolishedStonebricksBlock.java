...
public class MayaPolishedStonebricksBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_polished_stonebricks")
	public static final Block block = null;
	public MayaPolishedStonebricksBlock(XkdecoModElements instance) {
		super(instance, 268);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("maya_polished_stonebricks");
		}
