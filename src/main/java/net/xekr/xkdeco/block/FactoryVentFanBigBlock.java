...
public class FactoryVentFanBigBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_vent_fan_big")
	public static final Block block = null;
	public FactoryVentFanBigBlock(XkdecoModElements instance) {
		super(instance, 771);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("factory_vent_fan_big");
		}
