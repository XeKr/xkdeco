...
public class FactoryBiohazardRustingBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_biohazard_rusting")
	public static final Block block = null;
	public FactoryBiohazardRustingBlock(XkdecoModElements instance) {
		super(instance, 494);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_biohazard_rusting");
		}
