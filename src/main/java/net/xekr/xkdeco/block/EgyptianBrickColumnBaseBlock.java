...
public class EgyptianBrickColumnBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_brick_column_base")
	public static final Block block = null;
	public EgyptianBrickColumnBaseBlock(XkdecoModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_brick_column_base");
		}
