...
public class SnowyCobblestonePathStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:snowy_cobblestone_path_stair")
	public static final Block block = null;
	public SnowyCobblestonePathStairBlock(XkdecoModElements instance) {
		super(instance, 606);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("snowy_cobblestone_path_stair");
		}
