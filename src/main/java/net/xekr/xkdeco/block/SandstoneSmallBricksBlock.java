...
public class SandstoneSmallBricksBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:sandstone_small_bricks")
	public static final Block block = null;
	public SandstoneSmallBricksBlock(XkdecoModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_small_bricks");
		}
