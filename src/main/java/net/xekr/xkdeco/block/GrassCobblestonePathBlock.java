...
public class GrassCobblestonePathBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:grass_cobblestone_path")
	public static final Block block = null;
	public GrassCobblestonePathBlock(XkdecoModElements instance) {
		super(instance, 586);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("grass_cobblestone_path");
		}
