...
public class MayaPillarBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_pillar")
	public static final Block block = null;
	public MayaPillarBlock(XkdecoModElements instance) {
		super(instance, 272);
	}
