...
public class FactoryBiohazardRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_biohazard_rusted")
	public static final Block block = null;
	public FactoryBiohazardRustedBlock(XkdecoModElements instance) {
		super(instance, 495);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_biohazard_rusted");
		}
