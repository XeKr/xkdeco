...
public class YellowRoofBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:yellow_roof")
	public static final Block block = null;
	public YellowRoofBlock(XkdecoModElements instance) {
		super(instance, 52);
	}
