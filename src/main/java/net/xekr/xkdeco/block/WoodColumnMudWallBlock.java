...
public class WoodColumnMudWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:wood_column_mud_wall")
	public static final Block block = null;
	public WoodColumnMudWallBlock(XkdecoModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wood_column_mud_wall");
		}
