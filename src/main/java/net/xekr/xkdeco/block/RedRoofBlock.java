...
public class RedRoofBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof")
	public static final Block block = null;
	public RedRoofBlock(XkdecoModElements instance) {
		super(instance, 250);
	}
