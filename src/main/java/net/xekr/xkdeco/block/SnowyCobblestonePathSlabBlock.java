...
public class SnowyCobblestonePathSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:snowy_cobblestone_path_slab")
	public static final Block block = null;
	public SnowyCobblestonePathSlabBlock(XkdecoModElements instance) {
		super(instance, 597);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("snowy_cobblestone_path_slab");
		}
