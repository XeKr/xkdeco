...
public class MayaMossyBrickWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_mossy_brick_wall")
	public static final Block block = null;
	public MayaMossyBrickWallBlock(XkdecoModElements instance) {
		super(instance, 284);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_mossy_brick_wall");
		}
