...
public class FactoryDangerBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_danger")
	public static final Block block = null;
	public FactoryDangerBlock(XkdecoModElements instance) {
		super(instance, 478);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_danger");
		}
