...
public class OrangeMapleLeavesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:orange_maple_leaves")
	public static final Block block = null;
	public OrangeMapleLeavesBlock(XkdecoModElements instance) {
		super(instance, 608);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_maple_leaves");
		}
