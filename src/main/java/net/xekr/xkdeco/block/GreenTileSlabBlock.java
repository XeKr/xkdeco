...
public class GreenTileSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_tile_slab")
	public static final Block block = null;
	public GreenTileSlabBlock(XkdecoModElements instance) {
		super(instance, 227);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("green_tile_slab");
		}
