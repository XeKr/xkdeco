...
public class BlueRoofSteepSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_roof_steep_side")
	public static final Block block = null;
	public BlueRoofSteepSideBlock(XkdecoModElements instance) {
		super(instance, 237);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_roof_steep_side");
		}
