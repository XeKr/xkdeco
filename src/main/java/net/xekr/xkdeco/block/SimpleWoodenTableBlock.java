...
public class SimpleWoodenTableBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:simple_wooden_table")
	public static final Block block = null;
	public SimpleWoodenTableBlock(XkdecoModElements instance) {
		super(instance, 563);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("simple_wooden_table");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(4, 0, 4, 12, 2, 12), makeCuboidShape(6, 2, 6, 10, 14, 10), makeCuboidShape(0, 14, 0, 16, 16, 16))
