...
public class EbonyGooseneckChairColumnBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ebony_gooseneck_chair_column")
	public static final Block block = null;
	public EbonyGooseneckChairColumnBlock(XkdecoModElements instance) {
		super(instance, 204);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ebony_gooseneck_chair_column");
		}
