...
public class MayaMossyStonebrickSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_mossy_stonebrick_slab")
	public static final Block block = null;
	public MayaMossyStonebrickSlabBlock(XkdecoModElements instance) {
		super(instance, 278);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_mossy_stonebrick_slab");
		}
