...
public class FactoryRadiationBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_radiation")
	public static final Block block = null;
	public FactoryRadiationBlock(XkdecoModElements instance) {
		super(instance, 490);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_radiation");
		}
