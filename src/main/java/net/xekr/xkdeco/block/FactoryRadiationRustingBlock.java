...
public class FactoryRadiationRustingBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_radiation_rusting")
	public static final Block block = null;
	public FactoryRadiationRustingBlock(XkdecoModElements instance) {
		super(instance, 491);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_radiation_rusting");
		}
