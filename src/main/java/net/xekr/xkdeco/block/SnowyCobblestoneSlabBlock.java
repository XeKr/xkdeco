...
public class SnowyCobblestoneSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:snowy_cobblestone_slab")
	public static final Block block = null;
	public SnowyCobblestoneSlabBlock(XkdecoModElements instance) {
		super(instance, 592);
	}
