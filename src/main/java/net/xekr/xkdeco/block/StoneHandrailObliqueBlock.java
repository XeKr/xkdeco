...
public class StoneHandrailObliqueBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:stone_handrail_oblique")
	public static final Block block = null;
	public StoneHandrailObliqueBlock(XkdecoModElements instance) {
		super(instance, 711);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_handrail_oblique");
		}
