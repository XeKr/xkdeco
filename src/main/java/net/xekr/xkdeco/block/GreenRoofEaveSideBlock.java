...
public class GreenRoofEaveSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof_eave_side")
	public static final Block block = null;
	public GreenRoofEaveSideBlock(XkdecoModElements instance) {
		super(instance, 248);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_roof_eave_side");
		}
