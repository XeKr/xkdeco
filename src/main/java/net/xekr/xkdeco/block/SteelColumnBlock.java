...
public class SteelColumnBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:steel_column")
	public static final Block block = null;
	public SteelColumnBlock(XkdecoModElements instance) {
		super(instance, 467);
	}
