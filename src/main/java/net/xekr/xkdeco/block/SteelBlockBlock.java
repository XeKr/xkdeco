...
public class SteelBlockBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:steel_block")
	public static final Block block = null;
	public SteelBlockBlock(XkdecoModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(5f, 10f).setLightLevel(s -> 0).harvestLevel(0)
