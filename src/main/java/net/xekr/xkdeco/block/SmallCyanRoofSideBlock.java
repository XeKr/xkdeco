...
public class SmallCyanRoofSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_cyan_roof_side")
	public static final Block block = null;
	public SmallCyanRoofSideBlock(XkdecoModElements instance) {
		super(instance, 687);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_cyan_roof_side");
		}
