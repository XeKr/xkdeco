...
public class GlobeBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:globe")
	public static final Block block = null;
	public GlobeBlock(XkdecoModElements instance) {
		super(instance, 433);
	}
