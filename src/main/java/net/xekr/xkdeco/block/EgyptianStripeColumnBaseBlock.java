...
public class EgyptianStripeColumnBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_stripe_column_base")
	public static final Block block = null;
	public EgyptianStripeColumnBaseBlock(XkdecoModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_stripe_column_base");
		}
