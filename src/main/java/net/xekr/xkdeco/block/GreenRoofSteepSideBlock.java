...
public class GreenRoofSteepSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof_steep_side")
	public static final Block block = null;
	public GreenRoofSteepSideBlock(XkdecoModElements instance) {
		super(instance, 246);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_roof_steep_side");
		}
