...
public class RomanDoricColumnHeadBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:roman_doric_column_head")
	public static final Block block = null;
	public RomanDoricColumnHeadBlock(XkdecoModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("roman_doric_column_head");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(2, 0, 2, 14, 13, 14), makeCuboidShape(0, 13, 0, 16, 16, 16)).withOffset(offset.x, offset.y,
					offset.z);
		}
