...
public class CobblestonePathStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cobblestone_path_stair")
	public static final Block block = null;
	public CobblestonePathStairBlock(XkdecoModElements instance) {
		super(instance, 602);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_path_stair");
		}
