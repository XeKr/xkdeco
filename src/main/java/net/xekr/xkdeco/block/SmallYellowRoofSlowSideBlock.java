...
public class SmallYellowRoofSlowSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_yellow_roof_slow_side")
	public static final Block block = null;
	public SmallYellowRoofSlowSideBlock(XkdecoModElements instance) {
		super(instance, 695);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_yellow_roof_slow_side");
		}
