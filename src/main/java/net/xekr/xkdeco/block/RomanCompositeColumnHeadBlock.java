...
public class RomanCompositeColumnHeadBlock extends XkdecoModElements.ModElement {
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("roman_composite_column_head");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(1, 0, 1, 15, 8, 15), makeCuboidShape(0, 8, 0, 16, 16, 16)).withOffset(offset.x, offset.y, offset.z);
		}
