...
public class SmallCyanRoofEaveBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_cyan_roof_eave")
	public static final Block block = null;
	public SmallCyanRoofEaveBlock(XkdecoModElements instance) {
		super(instance, 684);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_cyan_roof_eave");
		}
