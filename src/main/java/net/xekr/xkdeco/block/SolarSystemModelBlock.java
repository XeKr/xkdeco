...
public class SolarSystemModelBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:solar_system_model")
	public static final Block block = null;
	public SolarSystemModelBlock(XkdecoModElements instance) {
		super(instance, 560);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("solar_system_model");
		}
