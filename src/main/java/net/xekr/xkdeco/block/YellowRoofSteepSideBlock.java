...
public class YellowRoofSteepSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:yellow_roof_steep_side")
	public static final Block block = null;
	public YellowRoofSteepSideBlock(XkdecoModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_roof_steep_side");
		}
