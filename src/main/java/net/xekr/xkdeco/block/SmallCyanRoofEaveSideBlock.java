...
public class SmallCyanRoofEaveSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_cyan_roof_eave_side")
	public static final Block block = null;
	public SmallCyanRoofEaveSideBlock(XkdecoModElements instance) {
		super(instance, 685);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_cyan_roof_eave_side");
		}
