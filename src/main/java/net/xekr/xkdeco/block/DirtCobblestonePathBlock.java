...
public class DirtCobblestonePathBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:dirt_cobblestone_path")
	public static final Block block = null;
	public DirtCobblestonePathBlock(XkdecoModElements instance) {
		super(instance, 585);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dirt_cobblestone_path");
		}
