...
public class WhiteCherryBlossomBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:white_cherry_blossom")
	public static final Block block = null;
	public WhiteCherryBlossomBlock(XkdecoModElements instance) {
		super(instance, 614);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("white_cherry_blossom");
		}
