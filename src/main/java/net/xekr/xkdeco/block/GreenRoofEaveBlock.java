...
public class GreenRoofEaveBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof_eave")
	public static final Block block = null;
	public GreenRoofEaveBlock(XkdecoModElements instance) {
		super(instance, 247);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_roof_eave");
		}
