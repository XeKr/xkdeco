...
public class MayaMossyBrickSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_mossy_brick_slab")
	public static final Block block = null;
	public MayaMossyBrickSlabBlock(XkdecoModElements instance) {
		super(instance, 282);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_mossy_brick_slab");
		}
