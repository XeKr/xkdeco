...
public class HologramPicturesItem extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hologram_pictures")
	public static final Item block = null;
	public HologramPicturesItem(XkdecoModElements instance) {
		super(instance, 826);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hologram_pictures");
		}
