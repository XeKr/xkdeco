...
public class GrassCobblestonePathStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:grass_cobblestone_path_stair")
	public static final Block block = null;
	public GrassCobblestonePathStairBlock(XkdecoModElements instance) {
		super(instance, 604);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("grass_cobblestone_path_stair");
		}
