...
public class VentiductBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ventiduct")
	public static final Block block = null;
	public VentiductBlock(XkdecoModElements instance) {
		super(instance, 744);
	}
				...
				default :
					return VoxelShapes
							.combineAndSimplify(VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 16, 16)),
									VoxelShapes.or(makeCuboidShape(2, 0, 2, 14, 16, 14)), IBooleanFunction.ONLY_FIRST)
							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
				case WEST :
					return VoxelShapes
							.combineAndSimplify(VoxelShapes.or(makeCuboidShape(0, 16, 0, 16, 0, 16)),
									VoxelShapes.or(makeCuboidShape(2, 14, 0, 14, 2, 16)), IBooleanFunction.ONLY_FIRST)
							.withOffset(offset.x, offset.y, offset.z);
				case UP :
				case DOWN :
					return VoxelShapes
							.combineAndSimplify(VoxelShapes.or(makeCuboidShape(0, 16, 16, 16, 0, 0)),
									VoxelShapes.or(makeCuboidShape(0, 14, 14, 16, 2, 2)), IBooleanFunction.ONLY_FIRST)
							.withOffset(offset.x, offset.y, offset.z);
			}
		}
