...
public class BlueTilesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_tiles")
	public static final Block block = null;
	public BlueTilesBlock(XkdecoModElements instance) {
		super(instance, 223);
	}
