...
public class FactoryToxicRustingBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_toxic_rusting")
	public static final Block block = null;
	public FactoryToxicRustingBlock(XkdecoModElements instance) {
		super(instance, 488);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_toxic_rusting");
		}
