...
public class YellowRidgeDecoCenterBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:yellow_ridge_deco_center")
	public static final Block block = null;
	public YellowRidgeDecoCenterBlock(XkdecoModElements instance) {
		super(instance, 692);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_ridge_deco_center");
		}
