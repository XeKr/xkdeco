...
public class FactoryToxicBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_toxic")
	public static final Block block = null;
	public FactoryToxicBlock(XkdecoModElements instance) {
		super(instance, 487);
	}
