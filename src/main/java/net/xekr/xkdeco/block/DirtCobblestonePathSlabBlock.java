...
public class DirtCobblestonePathSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:dirt_cobblestone_path_slab")
	public static final Block block = null;
	public DirtCobblestonePathSlabBlock(XkdecoModElements instance) {
		super(instance, 594);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dirt_cobblestone_path_slab");
		}
