...
public class CyanRoofSlowSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cyan_roof_slow_side")
	public static final Block block = null;
	public CyanRoofSlowSideBlock(XkdecoModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_roof_slow_side");
		}
