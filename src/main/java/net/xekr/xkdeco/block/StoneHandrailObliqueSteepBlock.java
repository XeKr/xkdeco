...
public class StoneHandrailObliqueSteepBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:stone_handrail_oblique_steep")
	public static final Block block = null;
	public StoneHandrailObliqueSteepBlock(XkdecoModElements instance) {
		super(instance, 712);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_handrail_oblique_steep");
		}
