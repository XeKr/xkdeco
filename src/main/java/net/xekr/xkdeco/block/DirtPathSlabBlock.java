...
public class DirtPathSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:dirt_path_slab")
	public static final Block block = null;
	public DirtPathSlabBlock(XkdecoModElements instance) {
		super(instance, 567);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(0.5f, 0.5f).setLightLevel(s -> 0).notSolid()
