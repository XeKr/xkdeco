...
public class SmallYellowRoofSteepSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_yellow_roof_steep_side")
	public static final Block block = null;
	public SmallYellowRoofSteepSideBlock(XkdecoModElements instance) {
		super(instance, 697);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_yellow_roof_steep_side");
		}
