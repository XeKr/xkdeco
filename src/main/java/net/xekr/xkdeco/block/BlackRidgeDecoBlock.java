...
public class BlackRidgeDecoBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:black_ridge_deco")
	public static final Block block = null;
	public BlackRidgeDecoBlock(XkdecoModElements instance) {
		super(instance, 670);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_ridge_deco");
		}
