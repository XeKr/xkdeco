...
public class MayaMossyBrickStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_mossy_brick_stair")
	public static final Block block = null;
	public MayaMossyBrickStairBlock(XkdecoModElements instance) {
		super(instance, 283);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_mossy_brick_stair");
		}
