...
public class SteelPillarBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:steel_pillar")
	public static final Block block = null;
	public SteelPillarBlock(XkdecoModElements instance) {
		super(instance, 466);
	}
