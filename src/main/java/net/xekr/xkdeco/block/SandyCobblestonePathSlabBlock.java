...
public class SandyCobblestonePathSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:sandy_cobblestone_path_slab")
	public static final Block block = null;
	public SandyCobblestonePathSlabBlock(XkdecoModElements instance) {
		super(instance, 596);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_cobblestone_path_slab");
		}
