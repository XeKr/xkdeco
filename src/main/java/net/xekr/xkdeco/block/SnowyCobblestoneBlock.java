...
public class SnowyCobblestoneBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:snowy_cobblestone")
	public static final Block block = null;
	public SnowyCobblestoneBlock(XkdecoModElements instance) {
		super(instance, 583);
	}
