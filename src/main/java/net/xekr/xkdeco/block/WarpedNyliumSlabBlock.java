...
public class WarpedNyliumSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:warped_nylium_slab")
	public static final Block block = null;
	public WarpedNyliumSlabBlock(XkdecoModElements instance) {
		super(instance, 578);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_nylium_slab");
		}
