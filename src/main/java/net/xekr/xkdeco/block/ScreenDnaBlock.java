...
public class ScreenDnaBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:screen_dna")
	public static final Block block = null;
	public ScreenDnaBlock(XkdecoModElements instance) {
		super(instance, 810);
	}
