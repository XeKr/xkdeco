...
public class MahoganyGooseneckChairColumnBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mahogany_gooseneck_chair_column")
	public static final Block block = null;
	public MahoganyGooseneckChairColumnBlock(XkdecoModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mahogany_gooseneck_chair_column");
		}
