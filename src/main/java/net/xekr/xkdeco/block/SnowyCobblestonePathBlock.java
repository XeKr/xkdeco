...
public class SnowyCobblestonePathBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:snowy_cobblestone_path")
	public static final Block block = null;
	public SnowyCobblestonePathBlock(XkdecoModElements instance) {
		super(instance, 588);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("snowy_cobblestone_path");
		}
