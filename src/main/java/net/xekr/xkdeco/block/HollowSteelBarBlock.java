...
public class HollowSteelBarBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hollow_steel_bar")
	public static final Block block = null;
	public HollowSteelBarBlock(XkdecoModElements instance) {
		super(instance, 742);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("hollow_steel_bar");
		}
