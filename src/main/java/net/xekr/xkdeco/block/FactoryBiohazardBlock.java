...
public class FactoryBiohazardBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_biohazard")
	public static final Block block = null;
	public FactoryBiohazardBlock(XkdecoModElements instance) {
		super(instance, 493);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_biohazard");
		}
