...
public class GrassCobblestoneSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:grass_cobblestone_slab")
	public static final Block block = null;
	public GrassCobblestoneSlabBlock(XkdecoModElements instance) {
		super(instance, 590);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("grass_cobblestone_slab");
		}
