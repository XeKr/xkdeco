...
public class BlueTileSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_tile_slab")
	public static final Block block = null;
	public BlueTileSlabBlock(XkdecoModElements instance) {
		super(instance, 224);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_tile_slab");
		}
