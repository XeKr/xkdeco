...
public class SmallBlackRoofSlowSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_black_roof_slow_side")
	public static final Block block = null;
	public SmallBlackRoofSlowSideBlock(XkdecoModElements instance) {
		super(instance, 677);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_black_roof_slow_side");
		}
