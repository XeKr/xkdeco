...
public class MudWallCrossStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mud_wall_cross_stair")
	public static final Block block = null;
	public MudWallCrossStairBlock(XkdecoModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mud_wall_cross_stair");
		}
