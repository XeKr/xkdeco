...
public class BlueRoofSlowBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_roof_slow")
	public static final Block block = null;
	public BlueRoofSlowBlock(XkdecoModElements instance) {
		super(instance, 234);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_roof_slow");
		}
