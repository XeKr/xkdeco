...
public class SandyCobblestonePathBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:sandy_cobblestone_path")
	public static final Block block = null;
	public SandyCobblestonePathBlock(XkdecoModElements instance) {
		super(instance, 587);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandy_cobblestone_path");
		}
