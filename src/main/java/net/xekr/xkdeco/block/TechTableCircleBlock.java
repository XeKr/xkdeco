...
public class TechTableCircleBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:tech_table_circle")
	public static final Block block = null;
	public TechTableCircleBlock(XkdecoModElements instance) {
		super(instance, 822);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("tech_table_circle");
		}
