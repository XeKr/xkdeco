...
public class EgyptianStripeColumnHeadBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_stripe_column_head")
	public static final Block block = null;
	public EgyptianStripeColumnHeadBlock(XkdecoModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_stripe_column_head");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(2, 0, 2, 14, 14, 14), makeCuboidShape(0, 14, 0, 16, 16, 16)).withOffset(offset.x, offset.y,
					offset.z);
		}
