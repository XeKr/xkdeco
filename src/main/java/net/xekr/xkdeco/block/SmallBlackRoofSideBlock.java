...
public class SmallBlackRoofSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_black_roof_side")
	public static final Block block = null;
	public SmallBlackRoofSideBlock(XkdecoModElements instance) {
		super(instance, 678);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_black_roof_side");
		}
