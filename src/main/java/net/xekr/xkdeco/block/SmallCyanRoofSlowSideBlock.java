...
public class SmallCyanRoofSlowSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_cyan_roof_slow_side")
	public static final Block block = null;
	public SmallCyanRoofSlowSideBlock(XkdecoModElements instance) {
		super(instance, 686);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_cyan_roof_slow_side");
		}
