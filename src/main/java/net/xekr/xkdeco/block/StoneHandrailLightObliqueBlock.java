...
public class StoneHandrailLightObliqueBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:stone_handrail_light_oblique")
	public static final Block block = null;
	public StoneHandrailLightObliqueBlock(XkdecoModElements instance) {
		super(instance, 720);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_handrail_light_oblique");
		}
