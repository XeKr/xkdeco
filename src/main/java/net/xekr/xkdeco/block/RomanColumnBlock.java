...
public class RomanColumnBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:roman_column")
	public static final Block block = null;
	public RomanColumnBlock(XkdecoModElements instance) {
		super(instance, 215);
	}
