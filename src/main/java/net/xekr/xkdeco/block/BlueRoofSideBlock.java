...
public class BlueRoofSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_roof_side")
	public static final Block block = null;
	public BlueRoofSideBlock(XkdecoModElements instance) {
		super(instance, 233);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_roof_side");
		}
