...
public class GreenRoofSteepBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof_steep")
	public static final Block block = null;
	public GreenRoofSteepBlock(XkdecoModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_roof_steep");
		}
