...
public class BlackRidgeDecoObliqueBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:black_ridge_deco_oblique")
	public static final Block block = null;
	public BlackRidgeDecoObliqueBlock(XkdecoModElements instance) {
		super(instance, 673);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_ridge_deco_oblique");
		}
