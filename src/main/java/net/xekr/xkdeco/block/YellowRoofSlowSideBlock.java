...
public class YellowRoofSlowSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:yellow_roof_slow_side")
	public static final Block block = null;
	public YellowRoofSlowSideBlock(XkdecoModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_roof_slow_side");
		}
