...
public class MayaStonebrickWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_stonebrick_wall")
	public static final Block block = null;
	public MayaStonebrickWallBlock(XkdecoModElements instance) {
		super(instance, 275);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_stonebrick_wall");
		}
