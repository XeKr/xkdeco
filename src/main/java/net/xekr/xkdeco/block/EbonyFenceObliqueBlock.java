...
public class EbonyFenceObliqueBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ebony_fence_oblique")
	public static final Block block = null;
	public EbonyFenceObliqueBlock(XkdecoModElements instance) {
		super(instance, 713);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("ebony_fence_oblique");
		}
