...
public class SmallBlackRoofEaveSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_black_roof_eave_side")
	public static final Block block = null;
	public SmallBlackRoofEaveSideBlock(XkdecoModElements instance) {
		super(instance, 676);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_black_roof_eave_side");
		}
