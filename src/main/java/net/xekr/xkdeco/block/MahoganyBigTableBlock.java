...
public class MahoganyBigTableBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mahogany_big_table")
	public static final Block block = null;
	public MahoganyBigTableBlock(XkdecoModElements instance) {
		super(instance, 145);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("mahogany_big_table");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(0, 8, 0, 16, 16, 16), makeCuboidShape(14, 0, 0, 16, 8, 2), makeCuboidShape(14, 0, 14, 16, 8, 16),
					makeCuboidShape(0, 0, 14, 2, 8, 16), makeCuboidShape(0, 0, 0, 2, 8, 2)).withOffset(offset.x, offset.y, offset.z);
		}
