...
public class FactorySlabRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_slab_rusted")
	public static final Block block = null;
	public FactorySlabRustedBlock(XkdecoModElements instance) {
		super(instance, 476);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("factory_slab_rusted");
		}
