...
public class GreenRoofBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof")
	public static final Block block = null;
	public GreenRoofBlock(XkdecoModElements instance) {
		super(instance, 241);
	}
