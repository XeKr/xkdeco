...
public class BlueRoofEaveBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_roof_eave")
	public static final Block block = null;
	public BlueRoofEaveBlock(XkdecoModElements instance) {
		super(instance, 238);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_roof_eave");
		}
