...
public class ScreenListBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:screen_list")
	public static final Block block = null;
	public ScreenListBlock(XkdecoModElements instance) {
		super(instance, 811);
	}
