...
public class FactoryLightBarBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_light_bar")
	public static final Block block = null;
	public FactoryLightBarBlock(XkdecoModElements instance) {
		super(instance, 782);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(0.2f, 10f)
					.setLightLevel(s -> 15).doesNotBlockMovement().notSolid().setNeedsPostProcessing((bs, br, bp) -> true)
					.setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false)).getDefaultState(),
			...
			setRegistryName("factory_light_bar");
		}
