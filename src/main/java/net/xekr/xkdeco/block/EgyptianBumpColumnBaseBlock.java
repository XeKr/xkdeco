...
public class EgyptianBumpColumnBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_bump_column_base")
	public static final Block block = null;
	public EgyptianBumpColumnBaseBlock(XkdecoModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_bump_column_base");
		}
