...
public class ScreenOffBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:screen_off")
	public static final Block block = null;
	public ScreenOffBlock(XkdecoModElements instance) {
		super(instance, 806);
	}
