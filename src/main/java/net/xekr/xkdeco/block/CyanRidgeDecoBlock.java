...
public class CyanRidgeDecoBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cyan_ridge_deco")
	public static final Block block = null;
	public CyanRidgeDecoBlock(XkdecoModElements instance) {
		super(instance, 681);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_ridge_deco");
		}
