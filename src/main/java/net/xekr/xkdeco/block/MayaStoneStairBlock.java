...
public class MayaStoneStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_stone_stair")
	public static final Block block = null;
	public MayaStoneStairBlock(XkdecoModElements instance) {
		super(instance, 261);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_stone_stair");
		}
