...
public class SteelTrapdoorBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:steel_trapdoor")
	public static final Block block = null;
	public SteelTrapdoorBlock(XkdecoModElements instance) {
		super(instance, 737);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("steel_trapdoor");
		}
