...
public class FactoryElectricityRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_electricity_rusted")
	public static final Block block = null;
	public FactoryElectricityRustedBlock(XkdecoModElements instance) {
		super(instance, 486);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_electricity_rusted");
		}
