...
public class GinkgoLeavesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ginkgo_leaves")
	public static final Block block = null;
	public GinkgoLeavesBlock(XkdecoModElements instance) {
		super(instance, 607);
	}
