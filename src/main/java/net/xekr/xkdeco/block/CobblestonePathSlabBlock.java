...
public class CobblestonePathSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cobblestone_path_slab")
	public static final Block block = null;
	public CobblestonePathSlabBlock(XkdecoModElements instance) {
		super(instance, 593);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_path_slab");
		}
