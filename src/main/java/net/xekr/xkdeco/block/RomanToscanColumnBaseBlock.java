...
public class RomanToscanColumnBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:roman_toscan_column_base")
	public static final Block block = null;
	public RomanToscanColumnBaseBlock(XkdecoModElements instance) {
		super(instance, 208);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("roman_toscan_column_base");
		}
