...
public class MayaStoneBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_stone")
	public static final Block block = null;
	public MayaStoneBlock(XkdecoModElements instance) {
		super(instance, 259);
	}
