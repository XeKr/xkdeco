...
public class PeachBlossomLeavesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:peach_blossom_leaves")
	public static final Block block = null;
	public PeachBlossomLeavesBlock(XkdecoModElements instance) {
		super(instance, 611);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("peach_blossom_leaves");
		}
