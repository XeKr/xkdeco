...
public class RedTileStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_tile_stair")
	public static final Block block = null;
	public RedTileStairBlock(XkdecoModElements instance) {
		super(instance, 231);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_tile_stair");
		}
