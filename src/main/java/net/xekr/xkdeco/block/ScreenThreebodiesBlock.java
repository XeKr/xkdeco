...
public class ScreenThreebodiesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:screen_threebodies")
	public static final Block block = null;
	public ScreenThreebodiesBlock(XkdecoModElements instance) {
		super(instance, 813);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(0.2f, 10f).setLightLevel(s -> 9).notSolid()
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("screen_threebodies");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case UP :
					return VoxelShapes.or(makeCuboidShape(0, 2, 0, 16, 0, 16)).withOffset(offset.x, offset.y, offset.z);
				case DOWN :
					return VoxelShapes.or(makeCuboidShape(0, 14, 16, 16, 16, 0)).withOffset(offset.x, offset.y, offset.z);
			}
		}
