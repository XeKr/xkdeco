...
public class GrassBlockSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:grass_block_slab")
	public static final Block block = null;
	public GrassBlockSlabBlock(XkdecoModElements instance) {
		super(instance, 568);
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("grass_block_slab");
		}
