...
public class FactoryBlockRustingBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_block_rusting")
	public static final Block block = null;
	public FactoryBlockRustingBlock(XkdecoModElements instance) {
		super(instance, 472);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_block_rusting");
		}
