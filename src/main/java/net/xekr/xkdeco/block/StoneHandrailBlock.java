...
public class StoneHandrailBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:stone_handrail")
	public static final Block block = null;
	public StoneHandrailBlock(XkdecoModElements instance) {
		super(instance, 707);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("stone_handrail");
		}
