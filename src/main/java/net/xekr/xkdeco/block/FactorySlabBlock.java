...
public class FactorySlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_slab")
	public static final Block block = null;
	public FactorySlabBlock(XkdecoModElements instance) {
		super(instance, 470);
	}
