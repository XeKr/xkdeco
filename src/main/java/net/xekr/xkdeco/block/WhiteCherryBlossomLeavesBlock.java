...
public class WhiteCherryBlossomLeavesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:white_cherry_blossom_leaves")
	public static final Block block = null;
	public WhiteCherryBlossomLeavesBlock(XkdecoModElements instance) {
		super(instance, 615);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("white_cherry_blossom_leaves");
		}
