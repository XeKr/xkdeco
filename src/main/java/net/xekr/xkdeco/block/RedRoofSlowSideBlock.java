...
public class RedRoofSlowSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof_slow_side")
	public static final Block block = null;
	public RedRoofSlowSideBlock(XkdecoModElements instance) {
		super(instance, 253);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_roof_slow_side");
		}
