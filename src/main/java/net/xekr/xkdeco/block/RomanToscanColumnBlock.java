...
public class RomanToscanColumnBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:roman_toscan_column")
	public static final Block block = null;
	public RomanToscanColumnBlock(XkdecoModElements instance) {
		super(instance, 326);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("roman_toscan_column");
		}
