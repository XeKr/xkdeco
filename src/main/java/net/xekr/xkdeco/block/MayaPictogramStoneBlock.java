...
public class MayaPictogramStoneBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_pictogram_stone")
	public static final Block block = null;
	public MayaPictogramStoneBlock(XkdecoModElements instance) {
		super(instance, 285);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("maya_pictogram_stone");
		}
