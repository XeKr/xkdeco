...
public class MayaBrickWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_brick_wall")
	public static final Block block = null;
	public MayaBrickWallBlock(XkdecoModElements instance) {
		super(instance, 276);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_brick_wall");
		}
