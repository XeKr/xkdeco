...
public class RedRoofRidgeBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof_ridge")
	public static final Block block = null;
	public RedRoofRidgeBlock(XkdecoModElements instance) {
		super(instance, 258);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("red_roof_ridge");
		}
