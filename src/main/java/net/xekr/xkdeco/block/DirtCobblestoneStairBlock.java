...
public class DirtCobblestoneStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:dirt_cobblestone_stair")
	public static final Block block = null;
	public DirtCobblestoneStairBlock(XkdecoModElements instance) {
		super(instance, 598);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dirt_cobblestone_stair");
		}
