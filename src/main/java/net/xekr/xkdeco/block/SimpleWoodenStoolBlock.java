...
public class SimpleWoodenStoolBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:simple_wooden_stool")
	public static final Block block = null;
	public SimpleWoodenStoolBlock(XkdecoModElements instance) {
		super(instance, 564);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("simple_wooden_stool");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(3, 0, 3, 13, 10, 13)).withOffset(offset.x, offset.y, offset.z);
		}
