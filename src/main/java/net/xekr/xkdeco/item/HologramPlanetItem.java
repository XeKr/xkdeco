...
public class HologramPlanetItem extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hologram_planet")
	public static final Item block = null;
	public HologramPlanetItem(XkdecoModElements instance) {
		super(instance, 824);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hologram_planet");
		}
