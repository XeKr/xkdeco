...
public class MechanicalConsoleBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mechanical_console")
	public static final Block block = null;
	public MechanicalConsoleBlock(XkdecoModElements instance) {
		super(instance, 815);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mechanical_console");
		}
