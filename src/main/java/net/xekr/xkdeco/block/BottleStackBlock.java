...
public class BottleStackBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:bottle_stack")
	public static final Block block = null;
	public BottleStackBlock(XkdecoModElements instance) {
		super(instance, 431);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(2, 0, 2, 14, 8, 14)).withOffset(offset.x, offset.y, offset.z);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.GLASS_BOTTLE, (int) (4)));
		}
	}
}
