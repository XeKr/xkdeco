...
public class SmallYellowRoofEaveBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_yellow_roof_eave")
	public static final Block block = null;
	public SmallYellowRoofEaveBlock(XkdecoModElements instance) {
		super(instance, 693);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_yellow_roof_eave");
		}
