...
public class GreenTilesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_tiles")
	public static final Block block = null;
	public GreenTilesBlock(XkdecoModElements instance) {
		super(instance, 226);
	}
