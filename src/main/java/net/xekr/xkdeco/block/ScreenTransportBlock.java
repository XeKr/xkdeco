...
public class ScreenTransportBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:screen_transport")
	public static final Block block = null;
	public ScreenTransportBlock(XkdecoModElements instance) {
		super(instance, 814);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("screen_transport");
		}
