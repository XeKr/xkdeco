...
public class BlueRoofEaveSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_roof_eave_side")
	public static final Block block = null;
	public BlueRoofEaveSideBlock(XkdecoModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_roof_eave_side");
		}
