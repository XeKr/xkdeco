...
public class MyceliumSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mycelium_slab")
	public static final Block block = null;
	public MyceliumSlabBlock(XkdecoModElements instance) {
		super(instance, 569);
	}
