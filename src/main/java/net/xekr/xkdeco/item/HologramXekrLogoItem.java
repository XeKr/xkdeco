...
public class HologramXekrLogoItem extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hologram_xekr_logo")
	public static final Item block = null;
	public HologramXekrLogoItem(XkdecoModElements instance) {
		super(instance, 828);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hologram_xekr_logo");
		}
