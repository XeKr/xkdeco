...
public class GreenRoofSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof_side")
	public static final Block block = null;
	public GreenRoofSideBlock(XkdecoModElements instance) {
		super(instance, 242);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_roof_side");
		}
