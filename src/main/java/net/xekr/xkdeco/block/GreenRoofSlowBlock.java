...
public class GreenRoofSlowBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:green_roof_slow")
	public static final Block block = null;
	public GreenRoofSlowBlock(XkdecoModElements instance) {
		super(instance, 243);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_roof_slow");
		}
