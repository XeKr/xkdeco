...
public class CyanRidgeDecoCenterBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cyan_ridge_deco_center")
	public static final Block block = null;
	public CyanRidgeDecoCenterBlock(XkdecoModElements instance) {
		super(instance, 683);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_ridge_deco_center");
		}
