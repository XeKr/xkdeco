...
public class GrassCobblestonePathSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:grass_cobblestone_path_slab")
	public static final Block block = null;
	public GrassCobblestonePathSlabBlock(XkdecoModElements instance) {
		super(instance, 595);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("grass_cobblestone_path_slab");
		}
