...
public class FactoryBlockBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_block")
	public static final Block block = null;
	public FactoryBlockBlock(XkdecoModElements instance) {
		super(instance, 469);
	}
