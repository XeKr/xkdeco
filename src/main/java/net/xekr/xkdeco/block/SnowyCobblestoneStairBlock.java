...
public class SnowyCobblestoneStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:snowy_cobblestone_stair")
	public static final Block block = null;
	public SnowyCobblestoneStairBlock(XkdecoModElements instance) {
		super(instance, 601);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("snowy_cobblestone_stair");
		}
