...
public class PodzolSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:podzol_slab")
	public static final Block block = null;
	public PodzolSlabBlock(XkdecoModElements instance) {
		super(instance, 570);
	}
