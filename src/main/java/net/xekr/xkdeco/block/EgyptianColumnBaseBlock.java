...
public class EgyptianColumnBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_column_base")
	public static final Block block = null;
	public EgyptianColumnBaseBlock(XkdecoModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_column_base");
		}
