...
public class FactoryDangerRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_danger_rusted")
	public static final Block block = null;
	public FactoryDangerRustedBlock(XkdecoModElements instance) {
		super(instance, 480);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_danger_rusted");
		}
