...
public class RedRoofEaveSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof_eave_side")
	public static final Block block = null;
	public RedRoofEaveSideBlock(XkdecoModElements instance) {
		super(instance, 257);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_roof_eave_side");
		}
