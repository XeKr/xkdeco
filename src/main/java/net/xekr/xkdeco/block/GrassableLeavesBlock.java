...
public class GrassableLeavesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:grassable_leaves")
	public static final Block block = null;
	public GrassableLeavesBlock(XkdecoModElements instance) {
		super(instance, 616);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("grassable_leaves");
		}
