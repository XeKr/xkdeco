...
public class EgyptianBumpColumnHeadBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_bump_column_head")
	public static final Block block = null;
	public EgyptianBumpColumnHeadBlock(XkdecoModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_bump_column_head");
		}
