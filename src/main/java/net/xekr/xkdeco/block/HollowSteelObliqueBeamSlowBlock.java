...
public class HollowSteelObliqueBeamSlowBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hollow_steel_oblique_beam_slow")
	public static final Block block = null;
	public HollowSteelObliqueBeamSlowBlock(XkdecoModElements instance) {
		super(instance, 739);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("hollow_steel_oblique_beam_slow");
		}
