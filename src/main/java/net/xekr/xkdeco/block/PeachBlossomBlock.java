...
public class PeachBlossomBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:peach_blossom")
	public static final Block block = null;
	public PeachBlossomBlock(XkdecoModElements instance) {
		super(instance, 610);
	}
