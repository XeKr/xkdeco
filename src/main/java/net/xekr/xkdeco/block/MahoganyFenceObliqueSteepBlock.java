...
public class MahoganyFenceObliqueSteepBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mahogany_fence_oblique_steep")
	public static final Block block = null;
	public MahoganyFenceObliqueSteepBlock(XkdecoModElements instance) {
		super(instance, 723);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("mahogany_fence_oblique_steep");
		}
