...
public class SteelColumnHeadBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:steel_column_head")
	public static final Block block = null;
	public SteelColumnHeadBlock(XkdecoModElements instance) {
		super(instance, 468);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("steel_column_head");
		}
