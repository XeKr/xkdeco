...
public class MayaStoneSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_stone_slab")
	public static final Block block = null;
	public MayaStoneSlabBlock(XkdecoModElements instance) {
		super(instance, 260);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_stone_slab");
		}
