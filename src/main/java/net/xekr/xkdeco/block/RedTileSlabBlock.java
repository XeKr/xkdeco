...
public class RedTileSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_tile_slab")
	public static final Block block = null;
	public RedTileSlabBlock(XkdecoModElements instance) {
		super(instance, 230);
	}
