...
public class StoneHandrailLightBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:stone_handrail_light")
	public static final Block block = null;
	public StoneHandrailLightBlock(XkdecoModElements instance) {
		super(instance, 716);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("stone_handrail_light");
		}
