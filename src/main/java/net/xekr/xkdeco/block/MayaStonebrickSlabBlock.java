...
public class MayaStonebrickSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_stonebrick_slab")
	public static final Block block = null;
	public MayaStonebrickSlabBlock(XkdecoModElements instance) {
		super(instance, 263);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_stonebrick_slab");
		}
