...
public class MayaChiseledStonebricksBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_chiseled_stonebricks")
	public static final Block block = null;
	public MayaChiseledStonebricksBlock(XkdecoModElements instance) {
		super(instance, 270);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("maya_chiseled_stonebricks");
		}
