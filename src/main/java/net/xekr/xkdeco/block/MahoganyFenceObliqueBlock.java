...
public class MahoganyFenceObliqueBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mahogany_fence_oblique")
	public static final Block block = null;
	public MahoganyFenceObliqueBlock(XkdecoModElements instance) {
		super(instance, 722);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("mahogany_fence_oblique");
		}
