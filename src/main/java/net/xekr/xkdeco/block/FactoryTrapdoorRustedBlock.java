...
public class FactoryTrapdoorRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_trapdoor_rusted")
	public static final Block block = null;
	public FactoryTrapdoorRustedBlock(XkdecoModElements instance) {
		super(instance, 774);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("factory_trapdoor_rusted");
		}
