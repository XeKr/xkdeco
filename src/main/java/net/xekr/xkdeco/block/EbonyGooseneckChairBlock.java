...
public class EbonyGooseneckChairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ebony_gooseneck_chair")
	public static final Block block = null;
	public EbonyGooseneckChairBlock(XkdecoModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ebony_gooseneck_chair");
		}
