...
public class EgyptianSmoothColumnBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:egyptian_smooth_column_base")
	public static final Block block = null;
	public EgyptianSmoothColumnBaseBlock(XkdecoModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("egyptian_smooth_column_base");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 4, 16), makeCuboidShape(2, 4, 2, 14, 16, 14)).withOffset(offset.x, offset.y, offset.z);
		}
