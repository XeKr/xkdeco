...
public class FactoryStairRustingBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_stair_rusting")
	public static final Block block = null;
	public FactoryStairRustingBlock(XkdecoModElements instance) {
		super(instance, 474);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("factory_stair_rusting");
		}
