...
public class HollowSteelHalfBeamBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:hollow_steel_half_beam")
	public static final Block block = null;
	public HollowSteelHalfBeamBlock(XkdecoModElements instance) {
		super(instance, 741);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("hollow_steel_half_beam");
		}
