...
public class MayaBrickStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_brick_stair")
	public static final Block block = null;
	public MayaBrickStairBlock(XkdecoModElements instance) {
		super(instance, 267);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_brick_stair");
		}
