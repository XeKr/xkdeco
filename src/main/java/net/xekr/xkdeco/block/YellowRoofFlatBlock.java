...
public class YellowRoofFlatBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:yellow_roof_flat")
	public static final Block block = null;
	public YellowRoofFlatBlock(XkdecoModElements instance) {
		super(instance, 689);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("yellow_roof_flat");
		}
