...
public class YellowRidgeDecoBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:yellow_ridge_deco")
	public static final Block block = null;
	public YellowRidgeDecoBlock(XkdecoModElements instance) {
		super(instance, 690);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_ridge_deco");
		}
