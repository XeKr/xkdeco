...
public class RedRoofSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof_side")
	public static final Block block = null;
	public RedRoofSideBlock(XkdecoModElements instance) {
		super(instance, 251);
	}
