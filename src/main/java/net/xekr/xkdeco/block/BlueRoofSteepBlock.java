...
public class BlueRoofSteepBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:blue_roof_steep")
	public static final Block block = null;
	public BlueRoofSteepBlock(XkdecoModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_roof_steep");
		}
