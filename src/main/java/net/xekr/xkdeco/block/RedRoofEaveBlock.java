...
public class RedRoofEaveBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:red_roof_eave")
	public static final Block block = null;
	public RedRoofEaveBlock(XkdecoModElements instance) {
		super(instance, 256);
	}
