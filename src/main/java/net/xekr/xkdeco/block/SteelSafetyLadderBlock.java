...
public class SteelSafetyLadderBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:steel_safety_ladder")
	public static final Block block = null;
	public SteelSafetyLadderBlock(XkdecoModElements instance) {
		super(instance, 743);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("steel_safety_ladder");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.combineAndSimplify(VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 16, 16)),
					VoxelShapes.or(makeCuboidShape(1, 0, 1, 15, 16, 15)), IBooleanFunction.ONLY_FIRST).withOffset(offset.x, offset.y, offset.z);
		}
