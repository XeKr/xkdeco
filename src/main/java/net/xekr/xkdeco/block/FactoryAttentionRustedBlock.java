...
public class FactoryAttentionRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_attention_rusted")
	public static final Block block = null;
	public FactoryAttentionRustedBlock(XkdecoModElements instance) {
		super(instance, 483);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_attention_rusted");
		}
