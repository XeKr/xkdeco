...
public class WallBaseBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:wall_base")
	public static final Block block = null;
	public WallBaseBlock(XkdecoModElements instance) {
		super(instance, 165);
	}
