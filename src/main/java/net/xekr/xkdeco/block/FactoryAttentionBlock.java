...
public class FactoryAttentionBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_attention")
	public static final Block block = null;
	public FactoryAttentionBlock(XkdecoModElements instance) {
		super(instance, 481);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_attention");
		}
