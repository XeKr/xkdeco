...
public class SandyCobblestonePathStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:sandy_cobblestone_path_stair")
	public static final Block block = null;
	public SandyCobblestonePathStairBlock(XkdecoModElements instance) {
		super(instance, 605);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_cobblestone_path_stair");
		}
