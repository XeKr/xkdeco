...
public class MayaBricksBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_bricks")
	public static final Block block = null;
	public MayaBricksBlock(XkdecoModElements instance) {
		super(instance, 265);
	}
