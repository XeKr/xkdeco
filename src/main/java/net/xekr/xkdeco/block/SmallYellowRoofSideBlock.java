...
public class SmallYellowRoofSideBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:small_yellow_roof_side")
	public static final Block block = null;
	public SmallYellowRoofSideBlock(XkdecoModElements instance) {
		super(instance, 696);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("small_yellow_roof_side");
		}
