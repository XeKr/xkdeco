...
public class PolishedSandstoneSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:polished_sandstone_slab")
	public static final Block block = null;
	public PolishedSandstoneSlabBlock(XkdecoModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_sandstone_slab");
		}
