...
public class BlackRidgeDecoCenterBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:black_ridge_deco_center")
	public static final Block block = null;
	public BlackRidgeDecoCenterBlock(XkdecoModElements instance) {
		super(instance, 674);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_ridge_deco_center");
		}
