...
public class FactoryBlockRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_block_rusted")
	public static final Block block = null;
	public FactoryBlockRustedBlock(XkdecoModElements instance) {
		super(instance, 475);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_block_rusted");
		}
