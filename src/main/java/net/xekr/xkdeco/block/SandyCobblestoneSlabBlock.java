...
public class SandyCobblestoneSlabBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:sandy_cobblestone_slab")
	public static final Block block = null;
	public SandyCobblestoneSlabBlock(XkdecoModElements instance) {
		super(instance, 591);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_cobblestone_slab");
		}
