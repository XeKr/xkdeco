...
public class GlassTilesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:glass_tiles")
	public static final Block block = null;
	public GlassTilesBlock(XkdecoModElements instance) {
		super(instance, 16);
	}
