...
public class EbonyObliqueBraceBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ebony_oblique_brace")
	public static final Block block = null;
	public EbonyObliqueBraceBlock(XkdecoModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("ebony_oblique_brace");
		}
