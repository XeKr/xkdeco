...
public class FactoryDangerRustingBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_danger_rusting")
	public static final Block block = null;
	public FactoryDangerRustingBlock(XkdecoModElements instance) {
		super(instance, 479);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_danger_rusting");
		}
