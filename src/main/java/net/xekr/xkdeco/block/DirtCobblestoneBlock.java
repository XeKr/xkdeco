...
public class DirtCobblestoneBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:dirt_cobblestone")
	public static final Block block = null;
	public DirtCobblestoneBlock(XkdecoModElements instance) {
		super(instance, 580);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dirt_cobblestone");
		}
