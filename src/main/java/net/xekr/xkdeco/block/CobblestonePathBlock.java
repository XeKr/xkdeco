...
public class CobblestonePathBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cobblestone_path")
	public static final Block block = null;
	public CobblestonePathBlock(XkdecoModElements instance) {
		super(instance, 584);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobblestone_path");
		}
