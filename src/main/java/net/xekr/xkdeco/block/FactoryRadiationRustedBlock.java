...
public class FactoryRadiationRustedBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:factory_radiation_rusted")
	public static final Block block = null;
	public FactoryRadiationRustedBlock(XkdecoModElements instance) {
		super(instance, 492);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("factory_radiation_rusted");
		}
