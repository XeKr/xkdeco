...
public class MudWallLineStairBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:mud_wall_line_stair")
	public static final Block block = null;
	public MudWallLineStairBlock(XkdecoModElements instance) {
		super(instance, 113);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mud_wall_line_stair");
		}
