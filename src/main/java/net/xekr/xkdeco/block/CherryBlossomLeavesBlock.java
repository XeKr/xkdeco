...
public class CherryBlossomLeavesBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:cherry_blossom_leaves")
	public static final Block block = null;
	public CherryBlossomLeavesBlock(XkdecoModElements instance) {
		super(instance, 613);
	}
