...
public class VentiductSixwayBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:ventiduct_sixway")
	public static final Block block = null;
	public VentiductSixwayBlock(XkdecoModElements instance) {
		super(instance, 748);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("ventiduct_sixway");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes
					.combineAndSimplify(VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 16, 16)), VoxelShapes.or(makeCuboidShape(2, 2, 0, 14, 14, 16),
							makeCuboidShape(2, 0, 2, 14, 16, 14), makeCuboidShape(0, 2, 2, 16, 14, 14)), IBooleanFunction.ONLY_FIRST)
