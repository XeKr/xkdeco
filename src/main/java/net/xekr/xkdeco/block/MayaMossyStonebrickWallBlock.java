...
public class MayaMossyStonebrickWallBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_mossy_stonebrick_wall")
	public static final Block block = null;
	public MayaMossyStonebrickWallBlock(XkdecoModElements instance) {
		super(instance, 280);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("maya_mossy_stonebrick_wall");
		}
