...
public class MayaMossyStonebricksBlock extends XkdecoModElements.ModElement {
	@ObjectHolder("xkdeco:maya_mossy_stonebricks")
	public static final Block block = null;
	public MayaMossyStonebricksBlock(XkdecoModElements instance) {
		super(instance, 277);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("maya_mossy_stonebricks");
		}
